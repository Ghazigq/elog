...
CFLAGS += -I$(PWD)/$(EASYLOGGER_PATH)/easylogger/plugins/file
CFLAGS += -I$(PWD)/log
...
# 添加到库中的源文件
lib-y := 
lib-y += linux_cfg/port/*.c
lib-y += $(EASYLOGGER_PATH)/easylogger/src/*.c
lib-y += $(EASYLOGGER_PATH)/easylogger/plugins/file/elog_file.c
lib-y += log/*.c
